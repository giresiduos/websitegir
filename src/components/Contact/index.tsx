            ...
            >
              ...
              <div className="mb-8">
                <a
                  ...
                  className="bg-primary hover:bg-primary/90 inline-flex w-full items-center justify-center gap-2 rounded-xs px-9 py-4 text-base font-medium text-white duration-300 sm:w-auto"
                >
                  <svg
                    width="20"
                    height="20"
