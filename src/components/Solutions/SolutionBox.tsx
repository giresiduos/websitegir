const SolutionBox = (props: {
  ...
  return (
    <div className="w-full">
      <div className="shadow-three hover:shadow-one dark:bg-gray-dark dark:shadow-two dark:hover:shadow-gray-dark relative z-10 rounded-lg bg-white px-8 py-10 lg:min-h-90 xl:min-h-85 2xl:min-h-75">
